...
# args.mode = 'higher'
args.regression_metric_name = 'rmse'
args.mode = 'lower'
...
for time_id in range(args.times):
    ...
    for epoch in range(args.num_epochs):
        # Train
        run_a_train_epoch_heterogeneous(args, epoch, model, train_loader, loss_criterion_cs, loss_criterion_r, optimizer, awl)
    ...
    logging.info(f'hidden_feats：{args.hidden_feats},conv2_out_dim:{args.conv2_out_dim}, gnn_out_feats:{args.gnn_out_feats},dropout:{args.dropout},bs:{args.batch_size},lr:{args.lr}')
